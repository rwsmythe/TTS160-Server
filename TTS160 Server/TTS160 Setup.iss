...
; Generated by Reid Smythe on 6/20/2024 (UTC)
;
[Setup]
AppID={{581ff016-46c6-4621-9258-a47f3bae324b}
AppName=ASCOM TTS160 Telescope Driver
AppVerName=ASCOM TTS160 Telescope Driver 354.1.2
AppVersion=354.1.2
...
OutputDir="."
OutputBaseFilename="TTS160 354.1.2 Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Telescope\TTS160"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Telescope\TTS160"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\astronomy\source\repos\TTS160 Server\TTS160 Server\bin\Release\ASCOM.TTS160.exe"; DestDir: "{app}"
; TODO: Add driver assemblies into the ServedClasses folder
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\astronomy\source\repos\TTS160 Server\TTS160 Server\Readme.pdf"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{app}\ASCOM.TTS160.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.TTS160.exe"; Parameters: "/unregister"
