//
// ASCOM.TTS160.Telescope Local COM Server
//
...
namespace ASCOM.LocalServer
{
    public static class Server
    {
        ...
        static void Main(string[] args)
        {
            ...
            TL = new TraceLogger("", "TTS160.LocalServer")
            {
            ...
            Thread.CurrentThread.Name = "TTS160 Local Server Thread";
        ...
        private static void RegisterObjects()
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error while registering the server:\n" + ex.ToString(), "ASCOM.TTS160.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return;
            }
            ...
            foreach (Type driverType in driverTypes)
            {
                ...
                try
                {
                    ...
                    using (var profile = new Profile())
                    {
                        ...
                        //profile.WriteValue(progId, "", chooserName);  //Update chooser name with new version ----> Profile won't let me do this!
                    }
                }
                catch (Exception ex)
                {
        ...
        private static void ElevateSelf(string argument)
        {
            ...
            {
                TL.LogMessage("IsAdministrator", $"The ASCOM.TTS160.Telescope was not " + (argument == "/register" ? "registered" : "unregistered because you did not allow it."));
                MessageBox.Show("The ASCOM.TTS160.Telescope was not " + (argument == "/register" ? "registered" : "unregistered because you did not allow it.", "ASCOM.TTS160.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Warning));
            }
            catch (Exception ex)
            {
                TL.LogMessageCrLf("IsAdministrator", $"Exception: {ex}");
                MessageBox.Show(ex.ToString(), "ASCOM.TTS160.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            return;
        }
        ...
        private static bool RegisterClassFactories()
        {
            ...
            foreach (Type driverType in driverTypes)
            {
                ...
                if (!factory.RegisterClassObject())
                {
                    ...
                    MessageBox.Show("Failed to register class factory for " + driverType.Name, "ASCOM.TTS160.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return false;
                }
            ...
            if (args.Length > 0)
            {
                switch (args[0].ToLower())
                {
                    ...
                    default:
                        ...
                        MessageBox.Show("Unknown argument: " + args[0] + "\nValid are : -register, -unregister and -embedding", "ASCOM.TTS160.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        break;
                }
            }
            else
